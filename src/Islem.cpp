...
{
    ifstream girisD("huffman.txt", ios::in|ios::binary);  //huffman.txt dosyasini binary ve in olarak acar.
    if(!girisD)
    {
        cout<<"huffman.txt Dosyasi Acilamadi !!!"<<endl;  //Acilmadigi halde hata ver
        exit(1);
    }
